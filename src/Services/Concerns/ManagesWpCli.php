...
trait ManagesWpCli
{
    ...
    use \hexa_package_wptoolkit\Services\Concerns\WpCli\SupportsWpCliMediaSelection;
    use \hexa_package_wptoolkit\Services\Concerns\WpCli\SupportsWpCliPostUpdates;
    /**
